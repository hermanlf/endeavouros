...
echo "Answare in the following format eg. 3840x2160@240"
...
figlet "GUI Apps"
echo -e "${NONE}"
#HF sudo pacman -Sy okular feh gwenview mpv qbittorrent bitwarden qalculate-gtk veracrypt --noconfirm
#HF yay -S onlyoffice-bin brave-bin librewolf-bin zen-browser-bin ventoy-bin webcord --noconfirm
...
echo -e "${NONE}"
sudo pacman -Sy tmux yazi fastfetch htop btop neovim --noconfirm
...
#HF figlet "Swapfile"
#HF echo -e "${NONE}"
#HF sudo mkswap -U clear --size 8G --file /swapfile
#HF sudo swapon /swapfile
#HF echo "/swapfile				  swap		 swap	 defaults   0 0" | sudo tee -a /etc/fstab
